                    ...
                    <div class="col-sm-4">
                        ...
                        <form id="userData">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="mf1" class="form-control" name="lastName"
                                       placeholder="Last name">
                            </div>
                            <div class="form-group">
                                <label for="firstName">First name</label>
                                <input type="text" id="mf2" class="form-control" name="firstName"
                                       placeholder="First name">
                            </div>
                            <div class="form-group">
                                <label for="patronymicName">Patronymic name</label>
                                <input type="text" id="mf3" class="form-control" name="patronymicName"
                                       placeholder="Patronymic name">
                            </div>
                            <div class="form-group">
                                <label for="login">Login</label>
                                <input type="text" id="mf4" class="form-control" name="login"
                                       placeholder="Login">
                            </div>
